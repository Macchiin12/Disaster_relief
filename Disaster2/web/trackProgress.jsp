...
<%
    ...
    try {
        ...
        e.printStackTrace();
        request.setAttribute("errorMessage", "Error loading beneficiaries for progress tracking: " + e.getMessage());
    }
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Disaster Relief - Track Distribution</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="content-area">
            <div class="form-card">
                <h1>Track Supply Distribution Progress</h1>
                <%
                    String status = request.getParameter("status");
                    if ("invalid_quantity".equals(status)) {
                        out.println("<p class='message'>Invalid quantity distributed.</p>");
                        ...
                        out.println("<p class='message'>Invalid input. Please check your entries.</p>");
                    }
                ...
                <form action="DistributionProgressServlet" method="post">
                    <%-- Hidden field for distributionId, used for updates. Will be empty for new records. --%>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="supplyItem" name="supplyItem" placeholder="e.g., Food Packs, Medical Kits" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="quantityDistributed" name="quantityDistributed" min="1" required>
                    </div>
                    <div class="form-group">
                    ...
                    <button type="submit">Save Distribution Progress</button>
                </form>
            </div>
        </div>
    </div>
